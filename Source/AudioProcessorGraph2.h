...
public:
    ...
    const String getName() const override { return "30HzOscillator"; }
...
public:
    ...
    const String getName() const override { return "440HzOscillator"; }
...
public:
    ...
    const String getName() const override { return "2kHzOscillator"; }
...
public:
    ...
    const String getName() const override { return "HPFilter"; }
...
public:
    ...
    const String getName() const override { return "LPFilter"; }
